        ...
        <div class="container">
            <div class="row">
                <div class="side-lists col-3">
                    ...
                    <li id="@if($list->user_id == Auth::id())user_{{$list->receiver_id}}@else user_{{$list->user_id}}@endif" class="list @if($user->id == $list->user_id OR $user->id == $list->receiver_id) active @endif">
